...
public class Paddle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        frozenTimer.AddTimerFinishedListener(UnfrozePaddle);
        EventManager.AddFreezerEffectActivateListener(FrozePaddle);
    }
    ...
    private void FrozePaddle(float duration)
    {
        isFrozen = true;
